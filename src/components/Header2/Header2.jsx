...
const Header2 = () => {
  return (
    <section>
        <div>
            <h1 className='text-4xl font-bold dark:text-white'>WHAT IS ASTRSC?</h1>
            <h2 className='text-3xl font-bold dark:text-white'>The Africa Stereotype Scanner (ASTRSC) is a tool that scans text for linguistic elements that often contribute to stereotypes about Africa.</h2>
            ...
            <h2 className='text-3xl font-bold dark:text-white'>*Disclaimer: ASTRSC does not replace critical thinking or a good editor!</h2>
            <button>Try ASTRSC</button>
            </div>
        </section>
  );
}
