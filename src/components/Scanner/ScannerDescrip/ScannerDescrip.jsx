...
const TextInput = () => {
  return (
    <div id="accordion-open" data-accordion="open" className='px-20 mt-6'>
        <h2 id="accordion-open-heading-1">
            <button type="button" className="bg-green-200 hover:border-green-300 flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 rounded-t-xl focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-green-300 dark:hover:bg-gray-800 gap-3" data-accordion-target="#accordion-open-body-1" aria-expanded="true" aria-controls="accordion-open-body-1">
